...
print('\"540\" adding up to \'9\' --> ' + str(add_operators('540',9)))
print('\"99990\" adding up to \'999\' --> ' + str(add_operators('99990',999)))
print('\"318420\" adding up to \'6\' --> ' + str(add_operators('318420',6)))