...
arr = [2,3,4,5,2,1,2,3,4,2,2,2,3,99,-111,0,2]
arr_sum = reduce(lambda x, y:x+y, arr)
print('Average of the array using the Normal method:\t' + str(arr_sum/len(arr)))
print('Average of the array using the Function method: ' + str(trimmean(arr,20))) # using 20%